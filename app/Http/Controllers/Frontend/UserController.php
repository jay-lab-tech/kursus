...
class UserController extends Controller
{
    ...
    public function profileEdit($id)
    {
        ...
        if ($id != auth()->user()->id) {
            // Legacy route - disabled for SPA system
            return redirect('/laravel-starter/public/dashboard.html');
        }
    ...
    public function profileUpdate(Request $request, $id)
    {
        ...
        return redirect('/laravel-starter/public/dashboard.html')->with('flash_success', 'Update successful!');
    }
