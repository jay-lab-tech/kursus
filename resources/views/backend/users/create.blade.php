        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <div class="form-group row mb-3">
                    {{ html()->label('Role (Enum)')->class('col-sm-2 form-label')->for('role') }}

                    <div class="col-sm-10">
                        {{ html()->select('role', ['admin' => 'Admin', 'instruktur' => 'Instruktur', 'mahasiswa' => 'Mahasiswa'], old('role', 'mahasiswa'))->class('form-control')->id('role') }}
                        <small class="form-text text-muted">User role untuk enrollment dan akses sistem</small>
                    </div>
                </div>
